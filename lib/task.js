...
{ name: 'epai几何100题', difficulty: 250, boosts: [{ type: '几何', amount: 100 }]},
{ name: '盆100题', difficulty: 10, boosts: [{ type: '几何', amount: 10 }, { type: '代数', amount: 10 }, { type: '高考课内', amount: 10 }]},
{ name: 'titu第一章', difficulty: 50, boosts: [{ type: '数论', amount: 10 }]},
{ name: 'titu第二章', difficulty: 100, boosts: [{ type: '数论', amount: 20 }]},
...
{ name: 'pftb随机一章', difficulty: 200, boosts: [{ type: '数论', amount: 50 }]},
{ name: 'pftb随机一章', difficulty: 200, boosts: [{ type: '组合', amount: 50 }]},
{ name: '图论入门', difficulty: 100, boosts: [{ type: '组合', amount: 60 }]},
...
{ name: 'lyl题集', difficulty: 200, boosts: [{ type: '代数', amount: 100 }]},
{ name: '陈计代数不等式', difficulty: 300, boosts: [{ type: '代数', amount: 10 }]},
{ name: 'hjj代数不等式', difficulty: 300, boosts: [{ type: '代数', amount: 200 }]},
{ name: '陵禹百题', difficulty: 200, boosts: [{ type: '代数', amount: 100 }]},
{ name: '高中课本随机一章', difficulty: 10, boosts: [{ type: '高中课内', amount: 10 }]},
{ name: '高中课本随机一章', difficulty: 10, boosts: [{ type: '高中课内', amount: 10 }]},
{ name: '高中课本随机一章', difficulty: 10, boosts: [{ type: '高中课内', amount: 10 }]},
{ name: '高中课本随机一章', difficulty: 10, boosts: [{ type: '高中课内', amount: 10 }]},
{ name: '高中课本随机一章', difficulty: 10, boosts: [{ type: '高中课内', amount: 10 }]},
{ name: '数之谜原创几何', difficulty: 150, boosts: [{ type: '几何', amount: 50 }]},
{ name: '数之谜原创代数', difficulty: 150, boosts: [{ type: '代数', amount: 50 }]},
{ name: '数之谜原创组合', difficulty: 150, boosts: [{ type: '组合', amount: 50 }]},
{ name: '数之谜原创数论', difficulty: 150, boosts: [{ type: '数论', amount: 50 }]},
{ name: '高等', difficulty: 300, boosts: [{ type: '数论', amount: 20 },{ type: '组合', amount: 20 },{ type: '代数', amount: 10 },{ type: '高中课内', amount: 10 }]},
{ name: '不知道哪来的模拟题', difficulty: 150, boosts: [{ type: '数论', amount: 50 },{ type: '组合', amount: 50 },{ type: '代数', amount: 50 },{ type: '高中课内', amount: 50 }]},
{ name: '不知道哪来的模拟题', difficulty: 200, boosts: [{ type: '数论', amount: 60 },{ type: '组合', amount: 60 },{ type: '代数', amount: 60 },{ type: '高中课内', amount: 60 }]},
{ name: '不知道哪来的模拟题', difficulty: 250, boosts: [{ type: '数论', amount: 50 },{ type: '组合', amount: 50 },{ type: '代数', amount: 50 },{ type: '高中课内', amount: 50 }]},
];
