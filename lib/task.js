...
const TASK_POOL = [{ name: '[谜之竞赛] 三月七', difficulty: 350, boosts: [{ type: '代数', amount: 100 }]},
{ name: 'epai几何100题', difficulty: 150, boosts: [{ type: '几何', amount: 100 }]},
{ name: '盆100题', difficulty: 10, boosts: [{ type: '几何', amount: 10 }, { type: '代数', amount: 10 }, { type: '高考课内', amount: 10 }]},
{ name: 'titu第一章', difficulty: 50, boosts: [{ type: '数论', amount: 1000 }]}, //TODO3
{ name: 'titu第二章', difficulty: 100, boosts: [{ type: '数论', amount: 2000 }]},
{ name: 'titu第三章', difficulty: 150, boosts: [{ type: '数论', amount: 30 }]},
{ name: 'titu第四章', difficulty: 200, boosts: [{ type: '数论', amount: 40 }]},
{ name: 'titu第五章', difficulty: 250, boosts: [{ type: '数论', amount: 50 }]},
{ name: 'pftb随机一章', difficulty: 150, boosts: [{ type: '数论', amount: 50 }]},
{ name: 'pftb随机一章', difficulty: 150, boosts: [{ type: '组合', amount: 50 }]},
{ name: '图论入门', difficulty: 200, boosts: [{ type: '组合', amount: 60 }]},
{ name: '奆猫组合题集', difficulty: 200, boosts: [{ type: '组合', amount: 100 }]},
{ name: '万喜人', difficulty: 150, boosts: [{ type: '几何', amount: 50 }]},
{ name: '禁书', difficulty: 600, boosts: [{ type: '几何', amount: 500 }]},
{ name: 'lyl题集', difficulty: 150, boosts: [{ type: '代数', amount: 100 }]},
{ name: '陈计代数不等式', difficulty: 300, boosts: [{ type: '代数', amount: 10 }]},
{ name: 'hjj代数不等式', difficulty: 200, boosts: [{ type: '代数', amount: 200 }]},
{ name: '凌禹百题', difficulty: 150, boosts: [{ type: '代数', amount: 100 }]},
{ name: '高中课本随机一章', difficulty: 10, boosts: [{ type: '高中课内', amount: 1000 }]},
{ name: '高中课本随机一章', difficulty: 10, boosts: [{ type: '高中课内', amount: 1000 }]},
{ name: '高中课本随机一章', difficulty: 10, boosts: [{ type: '高中课内', amount: 1000 }]},
{ name: '高中课本随机一章', difficulty: 10, boosts: [{ type: '高中课内', amount: 1000 }]},
{ name: '高中课本随机一章', difficulty: 10, boosts: [{ type: '高中课内', amount: 1000 }]},
{ name: '数之谜原创几何', difficulty: 10, boosts: [{ type: '几何', amount: 5000 }]},
{ name: '数之谜原创代数', difficulty: 10, boosts: [{ type: '代数', amount: 5000 }]},
{ name: '数之谜原创组合', difficulty: 10, boosts: [{ type: '组合', amount: 5000 }]},
{ name: '数之谜原创数论', difficulty: 10, boosts: [{ type: '数论', amount: 5000 }]},
{ name: '高等', difficulty: 150, boosts: [{ type: '数论', amount: 20 },{ type: '组合', amount: 20 },{ type: '代数', amount: 10 },{ type: '高中课内', amount: 10 }]},
{ name: '不知道哪来的模拟题', difficulty: 50, boosts: [{ type: '数论', amount: 50 },{ type: '组合', amount: 50 },{ type: '代数', amount: 50 },{ type: '高中课内', amount: 50 }]},
{ name: '不知道哪来的模拟题', difficulty: 100, boosts: [{ type: '数论', amount: 60 },{ type: '组合', amount: 60 },{ type: '代数', amount: 60 },{ type: '高中课内', amount: 60 }]},
{ name: '不知道哪来的模拟题', difficulty: 150, boosts: [{ type: '数论', amount: 50 },{ type: '组合', amount: 50 },{ type: '代数', amount: 50 },{ type: '高中课内', amount: 50 }]},
];
