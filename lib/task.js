...
{ name: '高中课本随机一章', difficulty: 10, boosts: [{ type: '高中课内', amount: 10 }]},
{ name: '高中课本随机一章', difficulty: 10, boosts: [{ type: '高中课内', amount: 10 }]},
{ name: '数之谜原创几何', difficulty: 100, boosts: [{ type: '几何', amount: 50 }]},
{ name: '数之谜原创代数', difficulty: 100, boosts: [{ type: '代数', amount: 50 }]},
{ name: '数之谜原创组合', difficulty: 100, boosts: [{ type: '组合', amount: 50 }]},
{ name: '数之谜原创数论', difficulty: 100, boosts: [{ type: '数论', amount: 50 }]},
