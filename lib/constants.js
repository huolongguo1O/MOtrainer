...
const COMPETITION_SCHEDULE = [
  ...
  {week:9, name:"校内预选", difficulty:65, maxScore:100, numProblems:1},
  {week:17, name:"预赛", difficulty:100, maxScore:200, numProblems:4, subtasksPerProblem:5},
  {week:25, name:"联赛", difficulty:150, maxScore:300, numProblems:4, subtasksPerProblem:3},
  {week:40, name:"省培", difficulty:250, maxScore:252, numProblems:12, subtasksPerProblem:7},
  {week:52, name:"CMO", difficulty:200, maxScore:126, numProblems:6, subtasksPerProblem:7},
  ...
  {week:53, name:"集训队一阶段测试1", difficulty:320, maxScore:42, numProblems:6, nationalTeam:true, subtasksPerProblem:7},
  {week:60, name:"集训队一阶段测试2", difficulty:320, maxScore:42, numProblems:6, nationalTeam:true, subtasksPerProblem:7},
  {week:65, name:"集训队二阶段", difficulty:390, maxScore:8, numProblems:12, nationalTeam:true, subtasksPerProblem:7},
  {week:80, name:"IMO", difficulty:250, maxScore:42, numProblems:6, nationalTeam:true, subtasksPerProblem:7}
];
...
const COMPETITION_DIFFICULTY_FACTORS = {
  ...
  "预赛": [0.5, 1.0, 1.5, 2.0],
  "联赛": [0.5, 0.8, 1.5, 2.5],
  "省培": [0.7, 0.7, 1.2, 1.5, 1.8, 1.8, 0.7, 0.7, 1.2, 1.5, 1.8, 1.8],
  "CMO": [0.5, 0.9, 2.0, 0.6, 1.0, 2.5],// 1.5],
  // 国家集训队比赛难度系数
  "集训队一阶段测试1": [1.2, 1.2, 3.0, 1.5, 1.5, 3.0],
  "集训队一阶段测试2": [1.2, 1.2, 3.0, 1.5, 1.5, 3.0],
  "集训队二阶段": [1.2, 1.2, 3.0, 1.5, 1.5, 3.0, 1.2, 1.2, 3.0, 1.5, 1.5, 3.0],
  "IMO": [0.4, 0.9, 1.5, 0.6, 1.0, 3.0]
};

// 明确的比赛链顺序（用于链式晋级判断）
// 国家集训队比赛不在此列表中，因为它们的晋级逻辑是特殊的
const COMPETITION_ORDER = ["校内预选","预赛","联赛","省培","CMO"];
...
const STRONG_PROVINCE_MAX_ABILITY = 170.0;
const NORMAL_PROVINCE_MIN_ABILITY = 30.0;
const NORMAL_PROVINCE_MAX_ABILITY = 155.0;
const WEAK_PROVINCE_MIN_ABILITY = 20.0;
const WEAK_PROVINCE_MAX_ABILITY = 145.0;
...
const CONTEST_GAIN_RATIOS = {
  // 正式比赛
  '校内预选': { knowledge: 0.3, thinking: 0.3, coding: 0.3 },      // 入门级
  '预赛': { knowledge: 0.5, thinking: 0.5, coding: 0.5 },      // 普及级
  '联赛': { knowledge: 0.7, thinking: 0.7, coding: 0.7 },        // NOIP级
  '省培': { knowledge: 0.9, thinking: 0.9, coding: 0.9 },        // 省选级
  'CMO': { knowledge: 1.0, thinking: 1.0, coding: 1.0 },         // NOI级（最高）
...
const ONLINE_CONTEST_TYPES = [
  {name: "二试模拟", numProblems: 4, difficulty: 100, displayName: "二试模拟"},
  //{name: "Atcoder-ARC", numProblems: 4, difficulty: 230, displayName: "Atcoder ARC"},
  {name: "谜之二试", numProblems: 4, difficulty: 120, displayName: "谜之二试"},
  {name: "谜之CMO", numProblems: 6, difficulty: 230, displayName: "谜之CMO"},
  {name: "谜之TST", numProblems: 6, difficulty: 370, displayName: "谜之TST"},
  {name: "NSMO", numProblems: 6, difficulty: 240, displayName: "NSMO"},
  {name: "归零杯", numProblems: 4, difficulty: 230, displayName: "归零杯"}
];
